...
<div class="card mt-3 shadow-sm mb-3">
    <div class="card-header bg-success text-white">
        <h5 class="card-title text-white">Add Product</h5>
    </div>
    <div class="card-body">
        <div class="mt-2 mb-2">
        ...
        <form id="product-registration-form" action="{{ route('admin.store_inventory') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="slug" name="slug" class="form-control" value="{{ old('slug') }}" placeholder="Product Slug" readonly>
                    @error('slug')
                    <span class="text-danger ml-1">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mt-2">
                    ...
                    <input type="number" name="quantity" class="form-control" value="{{ old('quantity') }}" placeholder="Enter quantity" step="0.01">
                    @error('quantity')
                    <span class="text-danger ml-1">{{ $message }}</span>
                    @enderror
                </div>
